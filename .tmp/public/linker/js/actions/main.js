  ...
  render: function() {
    ...
    return (
    	React.createElement("div", {className: "wrapper"}, 
    		React.createElement("div", {className: "status " + (!connected ? 'hidden' : "")}, connected ? this.state.user.name : ""), 
    		React.createElement("div", {className: "button " + (connected ? 'hidden' : ""), onClick: this.login}, "Log in with Facebook"), 
    		React.createElement("div", {className: "button " + (!connected ? 'hidden' : ""), onClick: this.logout}, "Log out")
    	)
    	);
  }
});
...
},{"../../../components/Login":1,"react":161}],3:[function(require,module,exports){
