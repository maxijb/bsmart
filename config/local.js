...
process.isDev = !(process.env.OPENSHIFT_NODEJS_PORT || process.env.OPENSHIFT_GEAR_NAME); 
 ...
 if (!process.isDev) {
      ...
      process.staticBaseUrl = "http://bsmart.com/" + process.timestamp + '/';

 } else {

      // local.js for development
      process.logQuery = false;
      module.exports = { 
      ...
      process.staticBaseUrl = '';
      // process.staticBaseUrl =  process.timestamp + '/';
 }